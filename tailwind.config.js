  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Background layers — each theme redefines these via CSS variables
        dungeon: {
          700: 'rgb(var(--dungeon-700) / <alpha-value>)',
          800: 'rgb(var(--dungeon-800) / <alpha-value>)',
          900: 'rgb(var(--dungeon-900) / <alpha-value>)',
        },
        // Accent colour family — replaces amber-* across the app
        theme: {
        ...
        // Text/ink colour family — replaces stone-* across the app
        prose: {
